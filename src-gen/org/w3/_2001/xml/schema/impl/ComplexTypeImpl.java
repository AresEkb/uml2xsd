 ...
 *   <li>{@link org.w3._2001.xml.schema.impl.ComplexTypeImpl#isMixed <em>Mixed</em>}</li>
...
public abstract class ComplexTypeImpl extends AnnotatedImpl implements ComplexType {
    ...
    public NotificationChain basicSetOpenContent(OpenContentType newOpenContent, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_TYPE__OPEN_CONTENT, oldOpenContent, newOpenContent);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setOpenContent(OpenContentType newOpenContent) {
        if (newOpenContent != openContent) {
            NotificationChain msgs = null;
            if (openContent != null)
                msgs = ((InternalEObject)openContent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_TYPE__OPEN_CONTENT, null, msgs);
            if (newOpenContent != null)
                msgs = ((InternalEObject)newOpenContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.COMPLEX_TYPE__OPEN_CONTENT, null, msgs);
            msgs = basicSetOpenContent(newOpenContent, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_TYPE__OPEN_CONTENT, newOpenContent, newOpenContent));
    }
    ...
    public EList<Assertion> getAssert() {
        if (assert_ == null) {
            assert_ = new EObjectContainmentEList<Assertion>(Assertion.class, this, SchemaPackage.COMPLEX_TYPE__ASSERT);
        }
        return assert_;
    }
    ...
    public void setDefaultAttributesApply(boolean newDefaultAttributesApply) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.COMPLEX_TYPE__DEFAULT_ATTRIBUTES_APPLY, oldDefaultAttributesApply, defaultAttributesApply, !oldDefaultAttributesApplyESet));
    }
    ...
    public void unsetDefaultAttributesApply() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, SchemaPackage.COMPLEX_TYPE__DEFAULT_ATTRIBUTES_APPLY, oldDefaultAttributesApply, DEFAULT_ATTRIBUTES_APPLY_EDEFAULT, oldDefaultAttributesApplyESet));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case SchemaPackage.COMPLEX_TYPE__OPEN_CONTENT:
            ...
            case SchemaPackage.COMPLEX_TYPE__ASSERT:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case SchemaPackage.COMPLEX_TYPE__BLOCK:
                return getBlock();
            case SchemaPackage.COMPLEX_TYPE__DEFAULT_ATTRIBUTES_APPLY:
