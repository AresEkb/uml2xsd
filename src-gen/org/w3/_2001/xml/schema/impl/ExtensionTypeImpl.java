...
public class ExtensionTypeImpl extends AnnotatedImpl implements ExtensionType {
    ...
    public NotificationChain basicSetOpenContent(OpenContentType newOpenContent, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchemaPackage.EXTENSION_TYPE__OPEN_CONTENT, oldOpenContent, newOpenContent);
    ...
    public void setOpenContent(OpenContentType newOpenContent) {
        if (newOpenContent != openContent) {
            ...
            if (openContent != null)
                msgs = ((InternalEObject)openContent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.EXTENSION_TYPE__OPEN_CONTENT, null, msgs);
            if (newOpenContent != null)
                msgs = ((InternalEObject)newOpenContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SchemaPackage.EXTENSION_TYPE__OPEN_CONTENT, null, msgs);
            msgs = basicSetOpenContent(newOpenContent, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.EXTENSION_TYPE__OPEN_CONTENT, newOpenContent, newOpenContent));
    }
    ...
    public EList<Assertion> getAssert() {
        if (assert_ == null) {
            assert_ = new EObjectContainmentEList<Assertion>(Assertion.class, this, SchemaPackage.EXTENSION_TYPE__ASSERT);
        }
        return assert_;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case SchemaPackage.EXTENSION_TYPE__OPEN_CONTENT:
            ...
            case SchemaPackage.EXTENSION_TYPE__ASSERT:
